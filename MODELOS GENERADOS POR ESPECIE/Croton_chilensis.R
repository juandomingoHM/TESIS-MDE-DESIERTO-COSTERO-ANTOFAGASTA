...
pres.comp<-read.table("~/especies/croton_chilensis/croton_chilensis.csv",header=T, sep=',', fill=TRUE, check.names=TRUE, stringsAsFactors=FALSE)
presencia<-pres.comp
...
write.csv(presencia, file = "~/especies/croton_chilensis/presencia&variables.csv")
...
write.table(presencia, file="~/especies/croton_chilensis/croton_chilensis_2.csv", sep=",", row.names=FALSE, quote=FALSE)
presencia
...
occs <- read.csv("~/especies/croton_chilensis/croton_chilensis_2.csv") #Datos de presencia
...
me <- maxent(oc.bg, y, args=c("addsamplestobackground=true"), 
             path="C:/Users/juand/Desktop/mxent/croton_chilensis/outputR2")

#contribucion por variable en el modelo Maxent 
var.importance(me)
me_df <- var.importance(me)
write.table(me_df, file="~/GEO/PUCV y we· 2020/plots finales/contribuciÛn variables/croton_chilensis.csv", sep=",", row.names=FALSE, quote=FALSE)
...
writeRaster(map,"C:/Users/juand/Desktop/mxent/croton_chilensis/croton_chilensis.tif",overwrite=T)
save(me,file="C:/Users/juand/Desktop/mxent/croton_chilensis/outputR2/mx_obj.RData")
...
load("C:/Users/juand/Desktop/mxent/croton_chilensis/outputR2/mx_obj.RData")
...
me_env <- maxent(env.values, y_env, args=c("addsamplestobackground=true"), path="C:/Users/juand/Desktop/mxent/croton_chilensis/outputR3")
...
for (i in 1:4){ #cambiar el numero de ciclo de acuerdo a los n∞ de k
  ...
  me_env2 <- maxent(env.values, y_env, args=c("addsamplestobackground=true"),
               path="C:/Users/juand/Desktop/mxent/croton_chilensis/outputR4")
...
plot(map, main = "Croton chilensis")
points(occs, pch='+', cex=0.5, col='black')
umbral <- (map >= umbral.tss)
class(umbral)
writeRaster(umbral,"C:/Users/juand/Desktop/mxent/croton_chilensis/croton_chilensis_umbral.tif",overwrite=T)
...
#correlaciones 
corr_var <- read.csv("~/especies/croton_chilensis/presencia&variables.csv")
corr_var
