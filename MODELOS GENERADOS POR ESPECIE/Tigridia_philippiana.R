...
pres.comp<-read.table("~/especies/tigridia_philippiana/tigridia_philippiana.csv",header=T, sep=',', fill=TRUE, check.names=TRUE, stringsAsFactors=FALSE)
presencia<-pres.comp
...
write.csv(presencia, file = "~/especies/tigridia_philippiana/presencia&variables.csv")
...
write.table(presencia, file="~/especies/tigridia_philippiana/tigridia_philippiana_2.csv", sep=",", row.names=FALSE, quote=FALSE)
presencia
...
occs <- read.csv("~/especies/tigridia_philippiana/tigridia_philippiana_2.csv") #Datos de presencia
...
me <- maxent(oc.bg, y, args=c("addsamplestobackground=true"), 
             path="C:/Users/juand/Desktop/mxent/tigridia_philippiana/outputR2")

#contribucion por variable en el modelo Maxent 
var.importance(me)
me_df <- var.importance(me)
write.table(me_df, file="~/GEO/PUCV y we· 2020/plots finales/contribuciÛn variables/tigridia_philippiana.csv", sep=",", row.names=FALSE, quote=FALSE)
...
writeRaster(map,"C:/Users/juand/Desktop/mxent/tigridia_philippiana/tigridia_philippiana.tif",overwrite=T)
save(me,file="C:/Users/juand/Desktop/mxent/tigridia_philippiana/outputR2/mx_obj.RData")
...
load("C:/Users/juand/Desktop/mxent/tigridia_philippiana/outputR2/mx_obj.RData")
...
me_env <- maxent(env.values, y_env, args=c("addsamplestobackground=true"), path="C:/Users/juand/Desktop/mxent/tigridia_philippiana/outputR3")
...
for (i in 1:2){ #cambiar el numero de ciclo de acuerdo a los n∞ de k
  ...
  me_env2 <- maxent(env.values, y_env, args=c("addsamplestobackground=true"),
               path="C:/Users/juand/Desktop/mxent/tigridia_philippiana/outputR4")
...
plot(map, main = "Tigridia philippiana")
points(occs, pch='+', cex=0.5, col='black')
umbral <- (map >= umbral.tss)
class(umbral)
writeRaster(umbral,"C:/Users/juand/Desktop/mxent/tigridia_philippiana/tigridia_philippiana_umbral.tif",overwrite=T)
...
#correlaciones 
corr_var <- read.csv("~/especies/tigridia_philippiana/presencia&variables.csv")
corr_var
