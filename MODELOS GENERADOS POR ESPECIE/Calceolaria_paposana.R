...
pres.comp<-read.table("~/especies/calceolaria_paposana/calceolaria_paposana.csv",header=T, sep=',', fill=TRUE, check.names=TRUE, stringsAsFactors=FALSE)
presencia<-pres.comp
...
write.csv(presencia, file = "~/especies/calceolaria_paposana/presencia&variables.csv")
...
write.table(presencia, file="~/especies/calceolaria_paposana/calceolaria_paposana_2.csv", sep=",", row.names=FALSE, quote=FALSE)
presencia
...
occs <- read.csv("~/especies/calceolaria_paposana/calceolaria_paposana_2.csv") #Datos de presencia
...
me <- maxent(oc.bg, y, args=c("addsamplestobackground=true"), 
             path="C:/Users/juand/Desktop/mxent/calceolaria_paposana/outputR2")

#contribucion por variable en el modelo Maxent 
var.importance(me)
me_df <- var.importance(me)
write.table(me_df, file="~/GEO/PUCV y we· 2020/plots finales/contribuciÛn variables/calceolaria_paposana.csv", sep=",", row.names=FALSE, quote=FALSE)
...
writeRaster(map,"C:/Users/juand/Desktop/mxent/calceolaria_paposana/calceolaria_paposana.tif",overwrite=T)
save(me,file="C:/Users/juand/Desktop/mxent/calceolaria_paposana/outputR2/mx_obj.RData")
...
load("C:/Users/juand/Desktop/mxent/calceolaria_paposana/outputR2/mx_obj.RData")
...
me_env <- maxent(env.values, y_env, args=c("addsamplestobackground=true"), path="C:/Users/juand/Desktop/mxent/calceolaria_paposana/outputR3")
...
for (i in 1:4){ #cambiar el numero de ciclo de acuerdo a los n∞ de k
  ...
  me_env2 <- maxent(env.values, y_env, args=c("addsamplestobackground=true"),
               path="C:/Users/juand/Desktop/mxent/calceolaria_paposana/outputR4")
...
plot(map, main = "Calceolaria paposana")
points(occs, pch='+', cex=0.5, col='black')
umbral <- (map >= umbral.tss)
class(umbral)
writeRaster(umbral,"C:/Users/juand/Desktop/mxent/calceolaria_paposana/calceolaria_paposana_umbral.tif",overwrite=T)
...
#correlaciones 
corr_var <- read.csv("~/especies/calceolaria_paposana/presencia&variables.csv")
corr_var
