...
# 1 PRECIPITACION MEDIA DE 10 AÑOS (2009-2018)

#lista de Bandas por año de precipitación mensual 12 meses 
...
precmean.10años<-brick(ras, ras2, ras3, ras4, ras5, ras6, ras7, ras8, ras9, ras10, ras11, ras12, ras13, ras14,
...
stack_brick <- stack(precmean.10años)
